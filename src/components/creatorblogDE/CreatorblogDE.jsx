      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          ...
          <div className='w-full lg:w-auto max-w-xl text-center lg:text-left'>
            <div className='flex items-center gap-4 mb-5 justify-center lg:justify-start'>
              <div className='bg-[#F5F5F5] rounded-[13px] px-4 py-1.5'>
                <h6 className="text-gray-500 text-[12px] cursor-pointer">Trends</h6>
              </div>
              <h1 className='text-gray-500 text-sm'>4 Min.</h1>
            </div>

            <h1 className='text-black font-bold text-2xl sm:text-3xl pb-4'>
              Aufstrebende Creator <br className='hidden lg:inline' />Trends für 2023
            </h1>
            <p className='text-gray-500 leading-5 text-[15px] font-medium pb-8'>
              Laut HubSpot wurde der Markt der Creator Economy im<br className='hidden lg:inline' />
              Jahr 2022 auf 104,2 Milliarden US-Dollar geschätzt, was <br className='hidden lg:inline' />
              einer Verdopplung des Werts gegenüber 2019 entspricht! <br className='hidden lg:inline' />
              Dabei stellt sich uns die Frage: Wird das enorme <br className='hidden lg:inline' />
              Wachstum auch 2023 noch bestehen.
            </p>
        ...
        <section data-aos="fade-up"
          ...
          <div className='flex gap-3 items-center flex-1'>
            ...
            <div>
              <h2 className='text-black font-bold text-lg'>Newsletter-Anmeldung</h2>
              <p className='text-gray-600 text-sm'>Erhalte mehr Beiträge zu interessanten Themen.</p>
            </div>
          </div>
