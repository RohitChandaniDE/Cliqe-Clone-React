  ...
  return (
    <div className='w-full'>
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16'>
        ...
        <h1 data-aos="fade-up" className='text-black font-bold text-center text-2xl sm:text-3xl pb-4'>
          Aktuelle Blog Posts
        </h1>
        <p data-aos="fade-up" className='text-gray-500 leading-5 text-[15px] text-center font-medium pb-8'>
          ...
          {filteredCards.map((card) => (
            <div key={card.id}
              ...
              <div className="overflow-hidden rounded-lg mb-4">
                <img src={card.imageSrc} alt="stock"
              ...
              <div className="flex items-center justify-between gap-3">
                <div className="flex gap-[15px] items-center min-w-0">
                  <img className="w-10 h-10 flex-shrink-0" src={card.authorImageSrc} alt="author" />
                  <div className='min-w-0'>
                    <h2 className="font-bold text-black text-sm">{card.authorName}</h2>
        ...
        <div data-aos="fade-up" className='flex flex-wrap justify-center items-center gap-6 lg:gap-10'>
          <img className='w-[120px] lg:w-[160px] h-auto' src="https://uploads-ssl.webflow.com/638a2cc04cd844a36eb3c00a/649999d6446ff0504255c35f_Sifted%20Logo-p-500.png" alt="Sifted" />
          <img className='w-[120px] lg:w-[160px] h-auto' src="https://uploads-ssl.webflow.com/638a2cc04cd844a36eb3c00a/649999d6628c4483a795aac8_Startup%20Insider%20Logo%20schwarz-p-500.png" alt="Startup Insider" />
          <img className='w-[120px] lg:w-[160px] h-auto' src="https://uploads-ssl.webflow.com/638a2cc04cd844a36eb3c00a/64999b3198cd93faa9c602ea_deutsche%20startups%20logo%20neu-p-500.png" alt="Deutsche Startups" />
          <img className='w-[120px] lg:w-[160px] h-auto' src="https://uploads-ssl.webflow.com/638a2cc04cd844a36eb3c00a/64999b31355ca807568ca4e9_Startbase-Logo-p-500.png" alt="Startbase" />
        </div>
