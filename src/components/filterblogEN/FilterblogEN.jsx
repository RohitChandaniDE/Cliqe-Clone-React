...
const FilterblogEN = () => {
  ...
  return (
    <div>
        ...
        <h1 data-aos = "fade-up" className='text-black font-bold text-center text-3xl pb-4' >Insights & Reflections</h1>
        <p data-aos = "fade-up" className='text-gray-500 leading-5 text-[15px] text-center font-medium pb-8'>Discover about various content creator topics including industry<br />insights, trends, best practices, our product and more!</p>
